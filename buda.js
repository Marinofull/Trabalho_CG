...
function handleKeyDown(event) {
	...
	switch (keyunicode) {
		...
		case 38	:	// Up cursor key
					cameraPos.elements[0] += 3.5; 
					cameraPos.elements[1] += 3.5;
					cameraPos.elements[2] += 3.5;
					break;
...
function webGLStartt() {
	...
	readOBJFile("../modelos/buddha2.obj", gl, 1, true);
	...
	var tick = function() {   // Start drawing
		if (g_objDoc != null && g_objDoc.isMTLComplete()) { // OBJ and all MTLs are available
			...
			g_objDoc = null;
			// defini as informações vértice AXIS
